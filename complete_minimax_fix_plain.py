...
def activate_network_blocker():
    ...
    print("ACTIVATING network call blocker...")
    ...
    if blocked_requests or blocked_httpx:
        print("SUCCESS: Network call blocker is ACTIVE")
        return True
    else:
        print("WARNING: No network libraries found to block")
        return False
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"SUCCESS: Blocked call test: {e}")
'''
